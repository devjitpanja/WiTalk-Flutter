                ...
                children: [
                  if (isParticipantInSeat) ...[
                    ...
                    _buildOptionButton(
                      ...
                      bgColor: const Color(0xFF0751DF).withOpacity(0.15),
                      onTap: onOffStage,
                      isFrozen: isFrozen,
                    ),
                  ] else ...[
                  ...
                  if (isHost && participant?['isHost'] != true)
                    _buildOptionButton(
                      ...
                      iconColor: participant?['isAdmin'] == true ? const Color(0xFFFFA500) : const Color(0xFF0751DF),
                      bgColor: participant?['isAdmin'] == true ? const Color(0xFFFFA500).withOpacity(0.15) : const Color(0xFF0751DF).withOpacity(0.15),
